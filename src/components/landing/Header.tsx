...
const Header = () => {
  return (
    <div>
      {/* Mobile Header */}
      <div className="sm:hidden w-full px-4 py-3 bg-white dark:bg-zinc-900 shadow-md border-b border-gray-200 dark:border-zinc-700 flex items-center justify-between mb-[100px]">
      ...
      <div className="sticky top-0 left-0 right-0 z-50">
        <div className="bg-white dark:bg-black/5 w-full">
          <div className="flex items-center justify-center w-full flex-col">
            <div
              className="
                hidden sm:flex flex-col sm:flex-row items-center justify-between
