---
title: Installation
description: Getting started with NovaUI
icon: ListStart
---
...
```bash tab="bun"
bunx shadcn@latest add https://ui.nova.dev/r/utils.json
```

```bash tab="npx"
npx shadcn@latest add https://ui.nova.dev/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.nova.dev/r/card-05.json
```

```bash tab="npx"
npx shadcn@latest add https://ui.nova.dev/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.nova.dev/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.nova.dev/r/ai-card-generation.json
```

```bash tab="npx"
npx shadcn@latest add https://ui.nova.dev/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.nova.dev/r/ai-card-generation.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://ui.nova.dev/r/card-05.json -c ./apps/www
```

```bash tab="npx"
npx shadcn@latest add https://ui.nova.dev/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://ui.nova.dev/r/card-05.json -c ./apps/www
```
